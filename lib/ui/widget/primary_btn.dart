  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        Positioned.fill(
            child: Padding(
          padding: EdgeInsets.only(left: markerWidth * 1.3),
          child: CustomPaint(
        ...
        Padding(
          padding: widget.padding ?? EdgeInsets.fromLTRB(16.0 + markerWidth * 1.3, 20.0, 16.0, 12.0),
          child: widget.child ?? SizedBox(width: 100.0),
        ),
        if (isHover)
          Positioned.fill(
            child: Padding(
